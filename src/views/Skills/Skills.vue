...
<section id="skills" class="section">
  <div class="container">
    ...
    <div class="skills columns is-multiline is-mobile">
      ...
      <div class="column is-half-mobile is-one-third-tablet is-one-quarter-desktop" v-for="(skill, index) in skills" :key="index">
        <div class="skill">
...
.graph_right #css {
    width: 70%;
    animation: stack_css 2s 1;
}

.graph_right .graph_3 span {
    width: 90%;
